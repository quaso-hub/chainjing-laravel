    ...
    <div class="page-inner">
        <div class="page-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createRUUModal">
                <i class="fas fa-plus"></i> Ajukan RUU Baru
            </button>
            <x-modal-create id="createRUUModal" labelledby="createRUUModalLabel" title="Ajukan RUU Baru"
                formId="formCreateRUU" action="{{ route('ruu.store') }}" submitText="Simpan">
                <div class="mb-3">
