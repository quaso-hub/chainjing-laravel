...
@section('content')
                            ...
                            <tr id="alokasi-row-{{ $item->id }}">
                                ...
                                <td>
                                    <button class="btn btn-warning btn-sm edit-alokasi-btn" data-id="{{ $item->id }}"
                                        data-nama_program="{{ $item->nama_program }}" data-jumlah="{{ $item->jumlah }}"
    ...
    <x-modal-create id="modalAlokasiDana" labelledby="modalAlokasiLabel" title="Alokasi Dana" formId="formAlokasi"
